...
- **README slimmed; full docs moved to `docs/`.** The root README is now
  intro + quick start + table of contents. Detailed content lives in
  `docs/getting-started.md`, `docs/integrations.md`, `docs/cli-reference.md`,
  and `docs/how-it-works.md`. No code or behavior changes.
